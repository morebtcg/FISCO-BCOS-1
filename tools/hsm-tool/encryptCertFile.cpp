...
int main(int argc, const char* argv[])
{
    ...
    auto const& securityConfig = nodeConfig->securityConfig();
    std::cout << "loadConfig success. hsmLibPath: " << securityConfig.hsmLibPath()
              << ", encKeyIndex: " << securityConfig.encKeyIndex() << std::endl;
