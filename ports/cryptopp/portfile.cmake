...
# Crypto++ 8.9.0 uses the stdext:: iterators that were removed from the MSVC STL
# in VS 2022 17.10 (MSVC 19.40) / VS 18.
#  * integer.cpp uses stdext::make_checked_array_iterator under MSC >= 1500.
#  * zdeflate.cpp passes stdext::make_unchecked_array_iterator under MSC >= 1600
#    even though the _STDEXT_BEGIN guard (namespace existence) is already false
#    on new MSVC, so std::mismatch was selected but still got stdext iterators.
# Restrict the stdext paths to MSVC builds that actually provide <stdext> and
# fall back to the plain iterators otherwise (matches upstream Crypto++'s fix).
vcpkg_replace_string("${SOURCE_PATH}/integer.cpp"
    "#if (CRYPTOPP_MSC_VERSION >= 1500)"
    "#if (CRYPTOPP_MSC_VERSION >= 1500) && (CRYPTOPP_MSC_VERSION < 1920)"
)
vcpkg_replace_string("${SOURCE_PATH}/zdeflate.cpp"
