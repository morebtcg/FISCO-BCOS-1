...
void tag_invoke(bcos::concepts::serialize::tag_t<bcos::concepts::serialize::encode> /*unused*/,
    bcostars::protocol::impl::TarsStruct auto const& object,
...
void tag_invoke(bcos::concepts::serialize::tag_t<bcos::concepts::serialize::decode> /*unused*/,
    bcos::concepts::bytebuffer::ByteBuffer auto const& buffer,
