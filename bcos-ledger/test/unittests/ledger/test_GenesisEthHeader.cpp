...
BOOST_AUTO_TEST_CASE(BuildsRlpHashMatchingPythonReference)
{
    task::syncWait([this]() -> task::Task<void> {
        ...
        // B0 timestamp is the artifact's, in seconds (the eth_sync pipeline keeps genesis
        // timestamps in seconds end-to-end; upstream converts to BlockHeader milliseconds).
