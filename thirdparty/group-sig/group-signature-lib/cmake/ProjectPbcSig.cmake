...
set(PBC_SIG_PATCH cp ${CMAKE_SOURCE_DIR}/patch/pbc_sig.patch ${CMAKE_SOURCE_DIR}/deps/src/pbc_sig && patch -f -p1 < ${CMAKE_SOURCE_DIR}/deps/src/pbc_sig/pbc_sig.patch && cp ${CMAKE_SOURCE_DIR}/cmake/fix_pbc_sig_cmake.py . && python3 fix_pbc_sig_cmake.py && cp ${CMAKE_CURRENT_LIST_DIR}/config.guess <SOURCE_DIR>)
