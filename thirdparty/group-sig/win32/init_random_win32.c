/*
 * init_random_win32.c - Win32 replacement for pbc-0.5.14/arith/init_random.c.
 * Uses the Windows CryptoAPI as the random source (upstream
 * init_random.win32.c, kept byte-for-byte compatible, with the deprecated
 * CryptoAPI deprecation warning suppressed).
 */
#include <stdio.h>
...
#pragma warning(disable : 4996) /* CryptAcquireContext etc. are deprecated but still available */
